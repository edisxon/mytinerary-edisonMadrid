            ...
            <header className='relative'>
                ...
                <div className="w-full flex justify-between px-2 pb-1 bg-blue-600 z-50 absolute" >
                    ...
                    <div className='flex flex-col lg:flex-row gap-2'>
                        ...
                        <a href="/"><img className="w-14" src="https://images.vexels.com/content/279735/preview/south-america-flat-continents-map-11e9a4.png" alt="" /></a>
                        
                        
                    </div>
                    <div className='flex items-center justify-center'>
                        <a href="/"><h1 className=' lg:text-3xl text-xl font-bold'>Mytinerary</h1></a>
  ...
  return (
    <div className="relative w-full h-screen z-0">
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center flex flex-col items-center gap-3">
        ...
        <a href="/cities" className='bg-blue-950 text-white flex rounded-3xl p-2 text-center'>¡Take me to all cities!</a>
      </div>
    </div>
  );
};
        ...
        >
          <div className="p-4">
            ...
            <ul>
              ...
              <li className="py-2"><a href="/cities">Cities</a></li>
